...
def multi_proc(score_path, n_components, label_code, full_df, custom_train_reps, \
    ...
    for i in range(iteration):
        print("iteration:", i)
        cur_res = entire_proc(n_components, label_code, full_df, custom_train_reps, male_count, female_count)
        res[i] = cur_res
