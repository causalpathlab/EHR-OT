...
#%% accuracy assesment
print("source_traindata shape is:", source_traindata.shape)
print("source_trainlabel shape is:", source_trainlabel.shape)
...
print("target_traindata is:", target_traindata)
print("target_trainlabel is:", target_trainlabel)
# print("acc shape is:", acc.shape)
