...
def learn_patient_representations(indir, input_file, output_file,
    ...
    :param output_file: output file containing patient representations (e.g., male_reps.txt)
    """
    ...
    mrn, encoded, encoded_avg, metrics_avg = train_and_evaluate(model,
                                                                ...
                                                                net.metrics,
                                                                exp_dir)
    print("encoded shape is:", np.array(encoded).shape)
    print("encoded_avg shape is:", np.array(encoded_avg).shape)
    np.savetxt(os.path.join(indir, output_file), encoded_avg)
...
def _process_args():
    ...
    parser.add_argument(dest='output_file', help='output file')
